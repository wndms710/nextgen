...
case 1340094912:
  ...
  ddata[0] = (vp1[0][0]+vp1[0][1]+vp1[0][2])/(vp1[0][0]+vp1[0][1]+vp1[0][2]-vp1[1][0]-vp1[1][1]-vp1[1][2]); // edge1 wgt
  ddata[1] = 0.0; // unused
  // intersection 1...
  idata[3] = NODE_NODE_INT;
  idata[4] = 0; // node0 index on tri0
...
case 2278462472:
  ...
  ddata[2] = (vp1[1][0]+vp1[1][1]+vp1[1][2])/(vp1[1][0]+vp1[1][1]+vp1[1][2]-vp1[2][0]-vp1[2][1]-vp1[2][2]); // edge1 wgt
  ddata[3] = 0.0; // unused
  return 2;
...
case 3886893742:
  ...
  ddata[2] = (vp1[2][0]+vp1[2][1]+vp1[2][2])/(vp1[2][0]+vp1[2][1]+vp1[2][2]-vp1[0][0]-vp1[0][1]-vp1[0][2]); // edge1 wgt
  ddata[3] = 0.0; // unused
  return 2;
